...
class SchemaService {
  ...
  static Future<RecordSchema> createLegacyCompatibleSchema() async {
    ...
    final schema = RecordSchema(
      schemaVersion: 1,
      fields: [
        _f('Shomare_Radif', 'شماره نامه', FieldType.number, system: true, deletable: false, required: true, searchable: true, sortable: true, order: 0, section: 'اطلاعات اصلی', gridSpan: 1),
        _f('date', 'تاریخ', FieldType.date, system: true, deletable: false, required: true, searchable: true, sortable: true, order: 1, section: 'اطلاعات اصلی', gridSpan: 1),
        _f('saheb_name', 'صاحب نامه', FieldType.text, searchable: true, sortable: true, suggestions: true, order: 2, section: 'اطلاعات اصلی', gridSpan: 2),
        _f('guy', 'موضوع', FieldType.text, searchable: true, suggestions: true, order: 3, section: 'اطلاعات اصلی', gridSpan: 2),
        _f('sh_name_reside', 'شماره تماس', FieldType.phone, searchable: true, order: 4, section: 'اطلاعات اصلی', gridSpan: 2),
        _f('onvan', 'گیرنده نامه', FieldType.text, searchable: true, suggestions: true, order: 5, section: 'اطلاعات اصلی', gridSpan: 2),
        _f('comment', 'توضیحات', FieldType.multiline, searchable: true, filterable: true, order: 6, section: 'اطلاعات اصلی', maxLines: 4, gridSpan: 2),
        _f('shomare_badi', 'شماره بعدی', FieldType.text, searchable: true, filterable: true, order: 7, section: 'اطلاعات اصلی', gridSpan: 2),
        ...
        _f('__category__', 'دسته‌بندی', FieldType.category, filterable: false, system: true, deletable: false, order: 14, section: 'اطلاعات اصلی', icon: 'label', gridSpan: 2),
      ],
      sections: const [
